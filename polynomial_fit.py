...
if __name__ == '__main__':
    ...
    parser.add_option('--x-min', default=None, type='int', help='x lower boundary')
    parser.add_option('--x-max', default=None, type='int', help='x upper boundary')
    parser.add_option('--y-min', default=None, type='int', help='y lower boundary')
    parser.add_option('--y-max', default=None, type='int', help='y upper boundary')
